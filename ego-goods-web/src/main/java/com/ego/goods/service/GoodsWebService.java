...
public class GoodsWebService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        //查询分类列表
        List<Category> categoryList = this.categoryClient.queryListByIds(ids);

        //查询品牌信息
        Brand brand = this.brandClient.queryListByIds(Collections.singletonList(spuBo.getBrandId())).get(0);
